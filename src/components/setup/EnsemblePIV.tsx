            ...
            {ensembleOptionsOpen && (
              <div className="mt-4 space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label className="text-sm">K-space Kurtosis Correction</Label>
                      <Button
                    ...
                    <p className="text-xs text-muted-foreground">
                      Ensemble PIV uses the closed-form k-space fit. Enabled (default): adds a per-axis (decoupled) kurtosis term — beats the Gaussian model where the displacement PDF is sub-Gaussian (validated on channel flow). Disabled: pure-Gaussian PDF, the robust baseline for near-Gaussian or low-SNR data.
                    </p>
                  </div>
