...
export function useDotboardCalibration(
  ...
  }, [imageFormat, imageType, numImages, calibrationSources, useCameraSubfolders, cameraSubfolders, patternCols, patternRows, dotSpacingMm, enhanceDots, asymmetric, dt]);
